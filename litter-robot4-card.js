 ...
 */class ot extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let n=s._$litPart$;if(void 0===n){const t=i?.renderBefore??null;s._$litPart$=n=new Q(e.insertBefore(k(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}}ot._$litElement$=!0,ot.finalized=!0,nt.litElementHydrateSupport?.({LitElement:ot});const rt=nt.litElementPolyfillSupport;var at,ct;rt?.({LitElement:ot}),(nt.litElementVersions??=[]).push("4.2.0"),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(at||(at={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ct||(ct={}));var lt=function(t,e,i,s){s=s||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n};class ht extends ot{static get properties(){return{hass:{type:Object},_config:{type:Object}}}setConfig(t){this._config=t}render(){if(!this.hass||!this._config)return W``;const t=this._config.entities||[],e=this._config.pet_weight_entities||[];return W`
    ...
    `}_valueChanged(t,e){if(!this._config)return;if(!t.target)return;const i=[...this._config.entities||[]];for(i[e]=t.detail.value;i.length<3;)i.push("");lt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{entities:i})})}_petWeightChanged(t,e){if(!this._config)return;if(!t.target)return;const i=[...this._config.pet_weight_entities||[]];t.detail.value?i[e]=t.detail.value:i.splice(e,1),lt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{pet_weight_entities:i})})}_addPetWeight(){if(!this._config)return;const t=[...this._config.pet_weight_entities||[],""];lt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{pet_weight_entities:t})})}_toggleMetric(t){const e=t.target;e&&this._config&&lt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{use_metric:e.checked})})}}ht.styles=o`
    .entities {
      padding: 8px;
    }
    .entity {
  ...
  `;try{console.debug("Defining custom elements..."),customElements.define("litter-robot4-card",dt),customElements.define("litter-robot4-editor",ht),console.debug("Custom elements defined successfully")}catch(t){console.error("Error defining custom elements:",t)}
